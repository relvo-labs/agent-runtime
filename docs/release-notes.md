...
| Claim                                        | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                     |
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Deterministic gate, all eight packages       | **Required, not yet established for this commit.** The policy asks for `pnpm gate` green on Node 22/24/26 against the commit being published, including packed-tarball install and import from a clean store and the packed reference app. That matrix is run by a reviewer against the committed SHA; authoring the versions does not produce it, and the gate's `changesets` step is separately blocked on a branch (#27). |
